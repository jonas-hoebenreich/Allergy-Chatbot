...
! function(t) {
	...
	var e = function() {
		...
		return Object.defineProperty(e.prototype, "type", {
			...
			this._eventTarget.dispatchEvent(new CustomEvent(t.TagEvents.ORIGINAL_ELEMENT_CHANGED, {
				detail: {
					value: this.value,
					tag: this
				}
	...
	var e = function(e) {
		...
		return __extends(n, e), Object.defineProperty(n.prototype, "active", {
			...
			this.inputElement.removeEventListener("blur", this.onInputBlurCallback, !1), this.onInputBlurCallback = null, this.inputElement.removeEventListener("focus", this.onInputFocusCallback, !1), this.onInputFocusCallback = null, document.removeEventListener("keydown", this.keyDownCallback, !1), this.keyDownCallback = null, document.removeEventListener("keyup", this.keyUpCallback, !1), this.keyUpCallback = null, this.eventTarget.removeEventListener(t.ControlElementEvents.SUBMIT_VALUE, this.onControlElementSubmitCallback, !1), this.onControlElementSubmitCallback = null,
				this.submitButton.el.removeEventListener(t.UserInputSubmitButtonEvents.CHANGE, this.onSubmitButtonChangeStateCallback, !1), this.onSubmitButtonChangeStateCallback = null, this.submitButton.dealloc(), this.submitButton = null, e.prototype.dealloc.call(this)
		}, n.prototype.getTemplate = function() {
			...
			if (this.originalResponse) {
				...
				if (-1 != e.indexOf("contains-image") && this.textEl.classList.add("contains-image"), this.isRobotResponse) {
					...
					if (0 === l) {
						...
						for (var p = this, d = 0; d < c.length; d++) ! function(e) {
							setTimeout(function() {
								t.tryClearThinking(), t.textEl.getElementsByTagName("p")[e].classList.add("show"), t.scrollTo()
							}, c.length > 1 && e > 0 ? l + (e + 1) * p.uiOptions.robot.chainedResponseTime : 0)
						}(d)
					} else
						for (var f = this, m = 0; m < c.length; m++) ! function(e) {
					...
					var g = e.indexOf("<img") > -1,
						v = new RegExp("<img[^>]*?>", "g"),
						b = e.match(v);
					g && b ? (e = e.replace(b[0], ""), this.textEl.innerHTML = '<p class="hasImage">' + b + "<span>" + e + "</span></p>") : this.textEl.innerHTML = "<p>" + e + "</p>";
					var E = this.textEl.getElementsByTagName("p");
					E[E.length - 1].offsetWidth, E[E.length - 1].classList.add("show"), this.scrollTo()
				}
...
! function(t) {
	...
	var e = function() {
		...
		return Object.defineProperty(e.prototype, "currentTag", {
			...
			this.maxSteps > 0 && (this.step == this.maxSteps ? (this.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.FORM_SUBMIT, {})), this.cfReference.doSubmitForm()) : (this.step %= this.maxSteps, this.currentTag.disabled ? this.skipStep() : this.showStep()))
	...
	var e = function() {
		...
		return Object.defineProperty(e.prototype, "createId", {
			...
			if (-1 == ["fixed", "absolute", "relative"].indexOf(window.getComputedStyle(this.context).getPropertyValue("position").toLowerCase()) && (this.context.style.position = "relative"), !this.tags || 0 == this.tags.length) {
				this.tags = [];
				for (var s = [].slice.call(this.formEl.querySelectorAll("input, select, button, textarea, cf-robot-message"), 0), r = 0; r < s.length; r++) {
					var a = s[r];
			...
			t.Dictionary.set(e, n, i), -1 != ["robot-image", "user-image"].indexOf(e) && this.chatList.updateThumbnail("robot-image" == e, i)
			...
			if (Object.keys(n).length > 0)
				for (var s in n)
					if (n[s].length > 0) {
						...
						r && "fieldset" !== r.tagName.toLowerCase() && (r = r.parentNode, function(t) {
							return t && "fieldset" !== t.tagName.toLowerCase() && !t.hasAttribute("cf-questions")
						}(r) && (r = null));
						for (var a = new t.TagGroup({
								fieldset: r,
								elements: n[s]
							}), i = 0; i < n[s].length; i++) {
							var l = n[s][i];
			...
			for (var o = [], s = 0; s < e.length; s++) {
				...
				if ("fieldset" === r.tag)
					for (var a = t.TagsParser.parseGroupTag(r), l = 0; l < a.children.length; l++) {
						...
						var c = "select" === r.tag ? t.TagsParser.parseGroupTag(r) : t.TagsParser.parseTag(r);
						if (t.Tag.isTagValid(c)) {
							var u = t.Tag.createTag(c);
							o.push(u)
						}
